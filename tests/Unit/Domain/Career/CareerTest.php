...
final class CareerTest extends Unit
{
    public function testStartCreatesAnActiveCareerWithUuidVersionSeven(): void
    {
        ...
        $career = Career::start(new CareerName('Porto rebuild'), new GameEdition('FC26'), $userId, $occurredAt);
    ...
    public function testDeleteThenRestorePreservesTheLastDeletionTimestamp(): void
    {
        ...
        $career = Career::start(new CareerName('Porto rebuild'), new GameEdition('FC26'), Uuid::uuid7($createdAt), $createdAt);
